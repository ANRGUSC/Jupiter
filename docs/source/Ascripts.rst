...
This page gives an overview of all public **Scripts** which helps to build and deploy the **Jupiter** system. 
...
.. toctree::
   ...
   scripts/write_deployment_specs
   scripts/write_home_specs
   scripts/write_profiler_service_specs
   scripts/write_profiler_specs
   scripts/write_service_specs
