...
def k8s_globalinfo_scheduler(app_name):
    ...
    for i in datasources:
        ...
        home_name =app_name+"-globalinfo"+i
    ...
    for i in datasources:
        ...
        home_dep = write_globalinfo_home_specs(name=home_name,image = jupiter_config.globalinfo_IMAGE, 
                                    host = jupiter_config.globalinfo_NODE[i][0], 
                                    appname = app_name,
