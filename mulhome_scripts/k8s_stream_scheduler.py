...
def k8s_demo_multipledata_scheduler(app_name):
    ...
    for idx, ds in enumerate(datasources):
        ...
        home_dep = write_stream_home_specs(name=home_name,label=home_name,image = ds['stream_image'], 
                                    ...
                                    dir = '{}',
                                    self_name=home_name,
                                    home_node_ip = circe_services.get(home_name),
                                    all_nodes = circe_nodes,
                                    all_nodes_ips = circe_nodes_ips)
