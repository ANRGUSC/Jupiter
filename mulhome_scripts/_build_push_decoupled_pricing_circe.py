...
def prepare_global_info():
    ...
    logging.debug('The list of ports to be exposed in the circe home are ', " ".join(port_list_home))
    ...
    logging.debug('The list of ports to be exposed in the circe workers are ', " ".join(port_list_worker))
