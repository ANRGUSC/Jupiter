...
def gen_duplicate_scripts(app_config, app_path, base_path, base_tasks):
    ...
    for task in tasklist:
        if task in base_tasks or task == 'home':
            ...
            if task.startswith('resnet'):
                ...
                basefile = os.path.join(app_path,'scripts/resnet1.py')
    ...
    try:
        ...
        app_folder = '../../app_specific_files/newdemotest'
...
if __name__ == '__main__':
    base_path = 'base'
    app_path = 'newdemotest'
    app_config = load_yaml(app_path + "/new_app_config.yaml")
