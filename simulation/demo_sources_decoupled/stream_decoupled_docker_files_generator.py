...
ADD simulation/demo_sources_decoupled/requirements_data.txt /requirements.txt
...
ADD simulation/demo_sources_decoupled/start_home.sh /start.sh
ADD simulation/demo_sources_decoupled/ds_stream.py /ds_stream.py
ADD simulation/demo_sources_decoupled/data /data
...
def write_stream_decoupled_home_docker(app_option=None,**kwargs):
    """
    ...
    dfp.content =template_decoupled_home.format(**kwargs)
    return file_name
