...
def set_globals():
	...
	HOME_IMAGE              = 'docker.io/anrg/circe_home:dummy'
	WORKER_IMAGE            = 'docker.io/anrg/circe_worker:dummy'

	"""DRUPE home and worker images"""
	global PROFILER_HOME_IMAGE, PROFILER_WORKER_IMAGE
	
	PROFILER_HOME_IMAGE     = 'docker.io/anrg/profiler_home:dummy'
	PROFILER_WORKER_IMAGE   = 'docker.io/anrg/profiler_worker:dummy'

	"""WAVE home and worker images"""
	global WAVE_HOME_IMAGE, WAVE_WORKER_IMAGE

	#dummy: random, v1: greedy

	WAVE_HOME_IMAGE         = 'docker.io/anrg/wave_home:dummy'
	WAVE_WORKER_IMAGE       = 'docker.io/anrg/wave_worker:dummy'

	"""Execution profiler home and worker images"""
	global EXEC_HOME_IMAGE, EXEC_WORKER_IMAGE


	EXEC_HOME_IMAGE         = 'docker.io/anrg/exec_home:dummy'
	EXEC_WORKER_IMAGE       = 'docker.io/anrg/exec_worker:dummy'

	"""HEFT docker image"""
	global HEFT_IMAGE

	HEFT_IMAGE              = 'docker.io/anrg/heft:dummy'
