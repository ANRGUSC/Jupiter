...
ADD circe/pricing_decouple/runtime_profiler_mongodb /central_mongod

ADD circe/pricing_decouple/readconfig.py /readconfig.py
ADD circe/pricing_decouple/scheduler.py /scheduler.py
ADD jupiter_config.py /jupiter_config.py
ADD circe/pricing_decouple/evaluate.py /evaluate.py
...
ADD circe/pricing_decouple/start_home.sh /start.sh
