...
# Add input files
COPY  app_specific_files/stresscpu30/sample_input /sample_input
...
RUN echo app_specific_files/stresscpu30/configuration.txt
ADD app_specific_files/stresscpu30/configuration.txt /configuration.txt
...
ADD app_specific_files/stresscpu30/name_convert.txt /centralized_scheduler/name_convert.txt
ADD app_specific_files/stresscpu30/sample_input/1botnet.ipsum /centralized_scheduler/1botnet.ipsum
