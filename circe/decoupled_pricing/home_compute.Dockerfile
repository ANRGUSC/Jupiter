...
# Add input files
COPY  app_specific_files/dummy_complex_30/sample_input /sample_input
...
RUN echo app_specific_files/dummy_complex_30/configuration.txt
ADD app_specific_files/dummy_complex_30/configuration.txt /configuration.txt
...
ADD app_specific_files/dummy_complex_30/name_convert.txt /centralized_scheduler/name_convert.txt
ADD app_specific_files/dummy_complex_30/sample_input/1botnet.ipsum /centralized_scheduler/1botnet.ipsum
ADD app_specific_files/dummy_complex_30/scripts/config.json /centralized_scheduler/config.json
ADD app_specific_files/dummy_complex_30/configuration.txt  /centralized_scheduler/dag.txt
