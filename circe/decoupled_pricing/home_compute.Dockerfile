...
# Add input files
COPY  app_specific_files/stressapp30/sample_input /sample_input
...
RUN echo app_specific_files/stressapp30/configuration.txt
ADD app_specific_files/stressapp30/configuration.txt /configuration.txt
