...
COPY circe/{pricing_option}/child_appointment.py /child_appointment.py
RUN mkdir -p DAG
ADD {app_file}/configuration.txt DAG/DAG_application.txt
ADD {app_file}/input_node.txt DAG
...
def write_decoupled_circe_computing_worker_docker(**kwargs):
    """
...
def write_decoupled_circe_controller_worker_docker(**kwargs):
    """
        Function to Generate the Dockerfile of the worker nodes
    """
...
def write_decoupled_circe_home_docker(**kwargs):
    """
...
if __name__ == '__main__':
    write_decoupled_circe_home_docker(username = 'root',
                      password = 'PASSWORD',
                      app_file='app_specific_files/network_monitoring',
                      ports = '22 8888')

    write_decoupled_circe_controller_worker_docker(username = 'root',
                      password = 'PASSWORD',
                      app_file='app_specific_files/network_monitoring',
                      ports = '22 57021')
    write_decoupled_computing_worker_docker(username = 'root',
                      password = 'PASSWORD',
                      app_file='app_specific_files/network_monitoring',
                      ports = '22 57021')

    # write_decoupled_controller_nondag(username = 'root',
    #                   password = 'PASSWORD',
    #                   app_file='app_specific_files/network_monitoring',
    #                   ports = '22 8888')