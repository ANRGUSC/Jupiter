...
ADD circe/pricing_coded/requirements.txt /requirements.txt
...
ADD circe/pricing_coded/runtime_profiler_mongodb /central_mongod

ADD circe/pricing_coded/readconfig.py /readconfig.py
ADD circe/pricing_coded/scheduler.py /scheduler.py
ADD jupiter_config.py /jupiter_config.py
ADD circe/pricing_coded/evaluate.py /evaluate.py
...
ADD circe/pricing_coded/monitor.py /centralized_scheduler/monitor.py
ADD circe/pricing_coded/start_home.sh /start.sh
