...
ADD circe/pricing_multiple_home/requirements.txt /requirements.txt
...
ADD circe/pricing_multiple_home/start_computing_worker.sh /start.sh
...
ADD app_specific_files/network_monitoring_app_dag/scripts/config.json /centralized_scheduler/config.json
...
ADD circe/pricing_multiple_home/compute.py /centralized_scheduler/compute.py
ADD circe/pricing_multiple_home/readconfig.py /readconfig.py
