...
ADD circe/pricing_final/requirements.txt /requirements.txt
...
ADD circe/pricing_final/runtime_profiler_mongodb /central_mongod

ADD circe/pricing_final/readconfig.py /readconfig.py
ADD circe/pricing_final/scheduler.py /scheduler.py
ADD jupiter_config.py /jupiter_config.py
ADD circe/pricing_final/evaluate.py /evaluate.py
...
ADD circe/pricing_final/monitor.py /centralized_scheduler/monitor.py
ADD circe/pricing_final/start_home.sh /start.sh
