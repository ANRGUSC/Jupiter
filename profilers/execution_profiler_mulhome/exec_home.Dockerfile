...
ADD app_specific_files/dummy_app_100/scripts/ /centralized_scheduler/
COPY app_specific_files/dummy_app_100/sample_input /centralized_scheduler/sample_input
RUN mkdir -p /home/darpa/apps/data


ADD app_specific_files/dummy_app_100/configuration.txt /centralized_scheduler/DAG.txt
