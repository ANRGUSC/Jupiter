...
ADD /app_specific_files/dummy_app_list/dummyapp2/scripts/ /centralized_scheduler/
COPY /app_specific_files/dummy_app_list/dummyapp2/sample_input /centralized_scheduler/sample_input

ADD /app_specific_files/dummy_app_list/dummyapp2/configuration.txt /centralized_scheduler/DAG.txt
