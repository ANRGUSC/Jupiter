...
COPY app_specific_files/dummycpu30/sample_input /centralized_scheduler/sample_input
RUN mkdir -p /home/darpa/apps/data


ADD app_specific_files/dummycpu30/configuration.txt /centralized_scheduler/DAG.txt
