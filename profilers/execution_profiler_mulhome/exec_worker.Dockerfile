...
ADD app_specific_files/dummyc/scripts/ /centralized_scheduler/
COPY app_specific_files/dummyc/sample_input /centralized_scheduler/sample_input
RUN mkdir -p /home/darpa/apps/data


ADD app_specific_files/dummyc/configuration.txt /centralized_scheduler/DAG.txt
