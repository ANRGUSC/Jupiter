...
ADD app_specific_files/dummy_app_combined/scripts/ /centralized_scheduler/
COPY app_specific_files/dummy_app_combined/sample_input /centralized_scheduler/sample_input
RUN mkdir -p /home/darpa/apps/data


ADD app_specific_files/dummy_app_combined/configuration.txt /centralized_scheduler/DAG.txt
