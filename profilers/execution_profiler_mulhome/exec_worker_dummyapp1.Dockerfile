...
ADD /app_specific_files/dummy_app_list/dummyapp1/scripts/ /centralized_scheduler/
COPY /app_specific_files/dummy_app_list/dummyapp1/sample_input /centralized_scheduler/sample_input
RUN mkdir -p /home/darpa/apps/data


ADD /app_specific_files/dummy_app_list/dummyapp1/configuration.txt /centralized_scheduler/DAG.txt
