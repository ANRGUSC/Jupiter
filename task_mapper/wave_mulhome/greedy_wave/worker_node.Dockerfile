...
ADD app_specific_files/dummy_complex_50/configuration.txt DAG/DAG_application.txt
ADD app_specific_files/dummy_complex_50/input_node.txt DAG
ADD app_specific_files/dummy_complex_50/sample_input /
