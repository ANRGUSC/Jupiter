...
def prepare_global():
    ...
    global task_assign_summary, docker_ip2node_name,node_list
    # Get ALL node info
    node_count = 0
    nodes = {}
    docker_ip2node_name = {}
...
def assign_task_to_remote(assigned_node, task_name):
    ...
    try:
        ...
        if BOKEH == 3:
            msg = 'msgoverhead randomwave home assignfirst 1 \n'
    ...
    while True:
        if len(assigned_tasks) == MAX_TASK_NUMBER:
            ...
            if BOKEH==3:
                ...
                msg = 'mappinglatency random wave %s %f \n' %(app_name,deploy_time)
...
def init_task_topology():
    ...
    rand_node = random.choice(list(node_list))

    init_tasks[rand_node] = [first_task]
