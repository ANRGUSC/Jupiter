...
ADD app_specific_files/MCPDAG/configuration.txt DAG/DAG_application.txt
ADD app_specific_files/MCPDAG/input_node.txt DAG
ADD app_specific_files/MCPDAG/sample_input/1botnet.ipsum /1botnet.ipsum
