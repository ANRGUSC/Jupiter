...
RUN echo app_specific_files/dummyapp100
ADD app_specific_files/dummyapp100/configuration.txt  /heft/dag.txt
ADD app_specific_files/dummyapp100/scripts/config.json /heft/config.json
