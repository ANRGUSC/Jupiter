...
RUN echo app_specific_files/dummy_complex_50
ADD app_specific_files/dummy_complex_50/configuration.txt  /heft/dag.txt
ADD app_specific_files/dummy_complex_50/scripts/config.json /heft/config.json
