...
RUN echo app_specific_files/demotest
ADD app_specific_files/demotest/configuration.txt  /heft/dag.txt
ADD app_specific_files/demotest/scripts/config.json /heft/config.json
