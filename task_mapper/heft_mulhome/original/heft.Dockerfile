...
RUN echo app_specific_files/dummyc
ADD app_specific_files/dummyc/configuration.txt  /heft/dag.txt
ADD app_specific_files/dummyc/scripts/config.json /heft/config.json
