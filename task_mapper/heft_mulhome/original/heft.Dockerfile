...
RUN echo app_specific_files/dummyapp50
ADD app_specific_files/dummyapp50/configuration.txt  /heft/dag.txt
ADD app_specific_files/dummyapp50/scripts/config.json /heft/config.json
