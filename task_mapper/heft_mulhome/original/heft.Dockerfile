...
RUN echo app_specific_files/demo5
ADD app_specific_files/demo5/configuration.txt  /heft/dag.txt
ADD app_specific_files/demo5/scripts/config.json /heft/config.json
