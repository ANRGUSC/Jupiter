...
RUN echo app_specific_files/demoduplicate
ADD app_specific_files/demoduplicate/configuration.txt  /heft/dag.txt
ADD app_specific_files/demoduplicate/scripts/config.json /heft/config.json
