...
RUN echo app_specific_files/dummycpu30
ADD app_specific_files/dummycpu30/configuration.txt  /heft/dag.txt
ADD app_specific_files/dummycpu30/scripts/config.json /heft/config.json
