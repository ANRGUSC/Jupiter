    ...
    def run_dup_split(self):
        ...
        while True:
            ...
            if self.is_link(btnk_id):
                ...
                new_node_id, min_btnk, task_ids_to_dup, task_ids_to_recv, parent_tasks, files_to_dst, files_from_src = \
                    dup.get_dup_node(self.links, self.processors, self.tasks, self.comp_cost, self.data, self.quaratic_profile, btnk_id)
                if new_node_id == -1:
                    break
